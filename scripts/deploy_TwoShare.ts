...
async function main() {
  ...
  const StableCoin = await ethers.getContractFactory('Twoshare');

  const stableCoin = await StableCoin.deploy(1641366000, "0xf827c3E5fD68e78aa092245D442398E12988901C");
  ...
  await hre.run('verify:verify', {
    ...
    constructorArguments: [1641366000, "0xf827c3E5fD68e78aa092245D442398E12988901C"],
  });
}
